      ...
      <p className={'title'}>Play-to-earn redneck racing</p>
        <p className={'subtitle'}>5555 NFTs <b>sold out</b> - get yours on secondary markets:</p>
          <div className={styles.buttons}>
           ...
           <a className={'black_button magic_eden'} target="_blank" href="https://magiceden.io/marketplace/panzerdogs"></a>
           <a className={'black_button fractal'} target="_blank" href="https://www.fractal.is/panzerdogs"></a>
      </div>
    </div>
    );
  };
